...
function purchase_records_add_meta_row(){
	var adding = `<tr><td class='pr_c1'><button id='pr_i_rb[]' name='pr_i_rb_2' class='purchase_records_metabox_item_line' type='button' onclick='purchase_records_remove_meta_row(jQuery(this))'>-</button></td>
		...
		<td class='pr_c4'><input type='hidden' name='pr_i_is[]' value='0'><input id='pr_i_is[]' name='pr_i_is[]' type='checkbox' value='1' class='purchase_records_metabox_item_table_items' style='position:relative;left:25%;'/></td>
		<td class='pr_c5'><input id='pr_i_cs[]' name='pr_i_cs[]' type='number' value='' class='purchase_records_metabox_item_table_items' step='0.001'/></td>
